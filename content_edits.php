								...
								<div class="row">
									...
									<div class="input-field col s3">
										...
										<label class="active" for="date2">
												...
												<label for="test5">To Present</label>
										</label>
									</div>
								...
								<div class="row">
									<div class="col s12">
										<div class="card-action" id="add">
											<a class="btn-flat grey col s12">+ ADD MORE</a>
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									<div class="col s12">
										<div class="card-action" id="addSk">
											<a class="btn-flat grey col s12">+ ADD MORE SKILLS</a>
										</div>
									</div>
								</div>
								<div class="row">
								...
								<div class="row">
									...
									<div class="input-field col s3">
										...
										<label class="active" for="date2">
											...
											<label for="test6">To Present</label>
										</label>
									</div>
									<div class="input-field col s5 offset-s1">
										<input name="position" type="text" class="validate">
...
<script>
	$(document).ready(function(){
		...
		$('#addSk').click(function(){
			$('#newSk').append('<div class="new"><div class="row"><div class="input-field col s12"><a class="right del"><i class="material-icons ">clear</i></a><input placeholder="SKILLS"  type="text" class="validate"><label class="active" for="last_name">Field Name</label></div></div><div class="row"><div class="input-field col s12"><input placeholder="For ex.Illustator" id="last_name" type="text" class="validate"></div></div></div>');
			$('.del').click(function(){
		...
		$('#addLan').click(function(){
			$('#Lang').append('<div class="newLan"><div class="row"><div class="input-field col s12"><a class="right del"><i class="material-icons ">clear</i></a><input placeholder="SKILLS" id="last_name" type="text" class="validate"><label class="active" for="last_name">Field Name</label></div></div><div class="row"><div class="input-field col s12"><input placeholder="For ex.Illustator" id="last_name" type="text" class="validate"></div></div></div>');
			$('.del').click(function(){
